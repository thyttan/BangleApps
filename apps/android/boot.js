(function() {
  ...
  Bangle.musicControl = cmd => {
    // play/pause/next/previous/volumeup/volumedown/vg(Volume Get level)/vs(Volume Set level)/seek
    if (typeof cmd !== "object") {gbSend({ t: "music", n:cmd });} else {gbSend({ t: "music", n:cmd.cmd, e:cmd.extra });}
  };
  // Message response
