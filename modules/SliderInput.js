exports.interfaceBoth = function(cb, conf) {
...
exports.interfaceVert = function(cb, conf) {
// Configuration for the indicator:
conf = conf?conf:{};
const USE_MAP = conf.useMap || false;
const USE_INCR = conf.useIncr || true;
...
let dragSlider = e=>{
  ...
  // If draging on the indicator, adjust one-to-one.
    if (USE_MAP && exFirst>Y_START-OVERSIZE_L*HEIGHT && exFirst<Y_START+HEIGHT+OVERSIZE_R*HEIGHT) {
